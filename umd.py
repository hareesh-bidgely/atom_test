...
def get_user_data(uuid,token):
    ...
    url='https://naapi-read.bidgely.com/meta/users/{uuid}/?access_token=1d3284dc-7364-4121-bbc0-110869bd2cba'.format(uuid=uuid)
...
def threads_executor(thread_count,user_sets_list,file_path):
    ...
    for j in range(thread_count):
        ...
        thread=threading.Thread(target=main_function, args=(users_list,token,file_path,))
